<template>
  <div id="app" class="w-3/5 mx-auto p-4 bg-gray-800 rounded-md m-4 relative overflow-hidden pt-14 mt-20">
    <div class="w-full absolute bg-purple-600 top-0 right-0 left-0 text-center text-white font-semibold text-x1 py-2">
      ...
      <form action="" @submit.prevent="addNewTodo()" class="border-b-2 border-purple-200 py-4" >
        ...
        <div class="mt-5 flex items-center justify-between">
          <!-- add todo button  -->
          <button class="px-4 py-2 text-xm font-semibold text-white bg-purple-800 rounded-sm focus:outline-none hover:bg-purple-500 focus:ring-4 ring-purple-800 ring-opacity-25 transition duration-100 ease-in-out transform hover:scale-105" >Add Todo</button>
          <!-- tick  button  -->
          <button 
          class="p-3 rounded-full focus:outline-none hover:bg-purple-600 hover:bg-opacity-25 mr-3"
